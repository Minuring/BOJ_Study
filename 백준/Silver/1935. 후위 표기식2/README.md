...
### 문제 풀이 
 ...
 <p>주어진 후위 표기식을 왼쪽부터 차례로 읽으면서, 다음 과정을 반복한다.</p>

- 피연산자를 만나면 <b>스택에 PUSH</b>한다.
- 연산자를 만나면 <b>스택</b>에서 피연산자 2개를 POP 후 연산결과를 PUSH한다.

 <p>이렇게 마지막 남은 한 개의 피연산자가 계산결과이다.</p>